...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg', default='models/yolov4-tiny.cfg', help='Darknet .cfg file')
    parser.add_argument('--weights', default='data/yolov4-tiny.weights', help='Darknet .weights file')
